...
public class AgeClassifierActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Classifier_AGE newClassifier;
    String whichPlaform = "";
    ...
    private void initialiseImageClassifier(Context app) {
        ...
        try {
            newClassifier = Classifier_AGE.getInstance(app);
        } catch (Exception e) {
...
//        pbText.setVisibility(View.VISIBLE);
    ...
    private class BackgroundProcessLocal extends AsyncTask<Bitmap, Void, ArrayList> {
        ...
        protected void onPostExecute(ArrayList s) {
            ...
            ArrayAdapter adapter = new ArrayAdapter<String>(AgeClassifierActivity.this,
