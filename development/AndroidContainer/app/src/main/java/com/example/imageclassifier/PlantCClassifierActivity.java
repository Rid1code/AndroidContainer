...
public class PlantCClassifierActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Classifier_conditions newClassifier;
    String whichPlaform = "";
    ...
    private void initialiseImageClassifier(Context app) {
        ...
        try {
            newClassifier = Classifier_conditions.getInstance(app);
        } catch (Exception e) {
...
//        pbText.setVisibility(View.VISIBLE);
        ...
        try {
            ...
            new PlantCClassifierActivity.BackgroundProcessLocal().execute(pickedBitmap);
    ...
    private class BackgroundProcessLocal extends AsyncTask<Bitmap, Void, ArrayList> {
        ...
        protected void onPostExecute(ArrayList s) {
            ...
            ArrayAdapter adapter = new ArrayAdapter<String>(PlantCClassifierActivity.this,
